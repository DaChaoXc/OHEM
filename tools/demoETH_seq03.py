...
if __name__ == '__main__':
    ...
    CONF_THRESH = 0.78
    nms_thresh = 0.35
    all_caffemodel = np.arange(1000,41000,1000)

    for caffemodel_num in all_caffemodel:
   
        fileoutpath="/home/vision/xc/fast-rcnn/data/ETH_test/txtSeq03/V003_%d.txt"%caffemodel_num ####

        caffemodel="/home/vision/xc/fast-rcnn/output/default/my_trainval/vgg16_fast_rcnn_iter_%d.caffemodel"%caffemodel_num
