...
if __name__ == '__main__':
    ...
    filepath="/home/vision/xc/fast-rcnn/data/ETH_test/seq02.txt" ####
    
    print '``````````````now deal with seq number:02````````````````' ####

    CONF_THRESH = 0.78
    nms_thresh = 0.35
    all_caffemodel = np.arange(4000,41000,1000)

    for caffemodel_num in all_caffemodel:
   
        fileoutpath="/home/vision/xc/fast-rcnn/data/ETH_test/txtSeq02/V002_%d.txt"%caffemodel_num ####
