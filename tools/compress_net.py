...
def parse_args():
    ...
    parser.add_argument('--def', dest='prototxt',
                        ...
                        default='/home/vision/xc/ohem/models/VGG16/test.prototxt', type=str)
    parser.add_argument('--def-svd', dest='prototxt_svd',
                        help='prototxt file defining the SVD compressed network',
                        default='/home/xc/ohem/models/VGG16/compressed/test.prototxt', type=str)
    parser.add_argument('--net', dest='caffemodel',
                        help='model to compress',
                        default='/home/vision/xc/ohem/output/fast_rcnn_ohem/my_trainval/vgg16_fast_rcnn_iter_26000.caffemodel', type=str)
