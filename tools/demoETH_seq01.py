...
if __name__ == '__main__':
    ...
    filepath="/home/vision/xc/fast-rcnn/data/ETH_test/seq01.txt" ####
    
    print '``````````````now deal with seq number:01````````````````' ####
    ...
    for caffemodel_num in all_caffemodel:
        ...
        fileoutpath="/home/vision/xc/fast-rcnn/data/ETH_test/txtSeq01/V001_%d.txt"%caffemodel_num ####
